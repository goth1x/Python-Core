...
Например список вида [1, 2, [3, 4, [5, 6]], 7] должен быть 
преобразован в плоский (flat) список [1, 2, 3, 4, 5, 6, 7]

Напишите функцию flatten, которая принимает на вход список, рекурсивно 
будет выравнивать этот список и возвращать плоскую версию списка.
