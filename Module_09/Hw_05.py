...
+380501112222
+380501112211
В этом случае идеально подойдет создание декоратора для функции sanitize_phone_number. Декоратор должен добавлять 
для коротких номеров префикс +38, а для полного международного номера (из 12 символом) — только знак +. 
