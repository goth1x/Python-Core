...
Создайте функцию caching_fibonacci(), которая будет обладать кешем с предыдуще вычисленными значениями 
чисел Фибоначчи. Внутри она содержит функцию fibonacci(n), которая непосредственно и будет вычислять 
само число Фибоначчи. Функция caching_fibonacci() возвращает функцию fibonacci
